...
impl DepthPreferredHashTable {
    ...
    pub fn set(&mut self, key: u64, bit_mask: u64, player: u8, depth: u8, cas_rights: u8, enp_sqr: usize, flag: u8, score: i32, mov: u32) -> bool {
...
mod tests {
    ...
    fn test_get_set_ar_entries() {
        ...
        table.set(10012, 101, 2, 5, 0, 0, 1, 200, 666);
        assert_eq!(LookupResult::Match(1, 200, 666), table.get(10012, 101, 2, 5, 0, 0));
        assert_eq!(LookupResult::NoMatch, table.get(10012, 101, 1, 10, 0, 0));
        assert_eq!(LookupResult::MovOnly(666), table.get(10012, 101, 2, 10, 0, 0));
        assert_eq!(LookupResult::NoMatch, table.get(10012, 101, 2, 10, 2, 0));
        assert_eq!(LookupResult::NoMatch, table.get(10012, 101, 2, 10, 0, 99));
    }
}
