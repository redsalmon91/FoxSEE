...
fn extract_features(state: &State) -> (FeatureMap, FeatureMap) {
    ...
    w_feature_map.weak_sqr_count = (W_BASE_MASK & !w_attack_mask & (b_attack_mask | bitboard.b_all)).count_ones() as i32;
    b_feature_map.weak_sqr_count = (B_BASE_MASK & !b_attack_mask & (w_attack_mask | bitboard.w_all)).count_ones() as i32;
