...
mod tests {
    ...
    fn test_q_search_1() {
        ...
        assert_eq!(220, search_engine.q_search(&mut state, -20000, 20000, 0, &mut 0));
    }
    ...
    fn test_q_search_4() {
        ...
        assert_eq!(-955, search_engine.q_search(&mut state, -20000, 20000, 0, &mut 0));
    }
    ...
    fn test_q_search_5() {
        ...
        assert_eq!(-280, search_engine.q_search(&mut state, -20000, 20000, 0, &mut 0));
    }
